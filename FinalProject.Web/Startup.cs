...
using FinalProject.Repository.Implementation;
using FinalProject.Repository.Interface;
using FinalProject.Services;
using FinalProject.Services.Implementation;
...
namespace FinalProject.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped(typeof(IRepository<>), typeof(Repository<>));  //za repos
            ...
            services.AddTransient<ITicketService, TicketService>(); //za servisi
